...
' +
    'Clicca OK per aggiungerlo alla lista della spesa
' +
    'Clicca Annulla per rimuoverlo definitivamente'
  );

  if (choice) {
    // OK = aggiungi alla lista della spesa
    ...
    // Annulla = rimuovi definitivamente
